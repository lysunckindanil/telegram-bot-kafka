...
import org.example.telegramhandleservice.services.TelegramHandleTextMessageService;
...
public class TelegramHandleController {
    private final TelegramHandleTextMessageService telegramHandleTextMessageService;
    ...
    public TelegramMessageResponseDto handleTextMessage(@RequestBody TelegramMessageDto telegramMessageDto) {
        String message = telegramHandleTextMessageService.handleTelegramTextMessage(telegramMessageDto);
